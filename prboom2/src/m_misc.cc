...
default_t defaults[] =
{
  ...
  {"process_priority", {&process_priority},{0},0,2,default_t::def_int,ss_none},
  ...
  {"default_compatibility_level",{(int*)&default_compatibility_level},
   ...
   default_t::def_int,ss_none}, // compatibility level" - CPhipps
  {"realtic_clock_rate",{&realtic_clock_rate},{100},0,UL,
   default_t::def_int,ss_none}, // percentage of normal speed (35 fps) realtic clock runs at
        {"menu_background", {(int*)&menu_background}, {1}, 0, 1,
         default_t::def_bool,ss_none}, // do Boom fullscreen menus have backgrounds?
        {"max_player_corpse", {&bodyquesize}, {32},-1,UL,   // killough 2/8/98
         default_t::def_int,ss_none}, // number of dead bodies in view supported (-1 = no limit)
        {"flashing_hom",{&flashing_hom},{0},0,1,
         default_t::def_bool,ss_none}, // killough 10/98 - enable flashing HOM indicator
        {"demo_insurance",{&default_demo_insurance},{2},0,2,  // killough 3/31/98
         default_t::def_int,ss_none}, // 1=take special steps ensuring demo sync, 2=only during recordings
        {"endoom_mode", {&endoom_mode},{5},0,7, // CPhipps - endoom flags
         default_t::def_hex, ss_none}, // 0, +1 for colours, +2 for non-ascii chars, +4 for skip-last-line
        {"level_precache",{(int*)&precache},{1},0,1,
         default_t::def_bool,ss_none}, // precache level data?
        {"demo_smoothturns", {&demo_smoothturns},  {0},0,1,
         default_t::def_bool,ss_stat},
        {"demo_smoothturnsfactor", {&demo_smoothturnsfactor},  {6},1,SMOOTH_PLAYING_MAXFACTOR,
         default_t::def_int,ss_stat},
        {"boom_autoswitch", {(int*)&boom_autoswitch}, {1}, 0, 1, default_t::def_bool, ss_none},

        {"Files",{NULL},{0},UL,UL,default_t::def_none,ss_none},
    /* cph - MBF-like wad/deh/bex autoload code */
        {"wadfile_1",{NULL,&wad_files[1]},{0,""},UL,UL,default_t::def_str,ss_none},
        {"wadfile_2",{NULL,&wad_files[2]},{0,""},UL,UL,default_t::def_str,ss_none},
        {"dehfile_1",{NULL,&deh_files[0]},{0,""},UL,UL,default_t::def_str,ss_none},
        {"dehfile_2",{NULL,&deh_files[1]},{0,""},UL,UL,default_t::def_str,ss_none},
    ...
    // [FG] colored blood and gibs
        ...
        {"sts_pct_always_gray",{&sts_pct_always_gray},{0},0,1, // 2/23/98 chg default
         default_t::def_bool,ss_stat}, // makes percent signs on status bar always gray
        {"sts_traditional_keys",{&sts_traditional_keys},{0},0,1,  // killough 2/28/98
         default_t::def_bool,ss_stat}, // disables doubled card and skull key display on status bar
        {"sts_armorcolor_type",{&sts_armorcolor_type},{1},0,1, //  armor color depends on type
         default_t::def_bool,ss_stat},
        {"show_messages",{&showMessages},{1},0,1,
         default_t::def_bool,ss_none}, // enables message display
        {"autorun",{&autorun},{1},0,1,  // killough 3/6/98: preserve autorun across games
         default_t::def_bool,ss_none},

        {"Dehacked settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        {"deh_apply_cheats",{&deh_apply_cheats},{1},0,1,
         default_t::def_bool,ss_stat}, // if 0, dehacked cheat replacements are ignored.

        {"Compatibility settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        {"comp_zombie",{&default_comp[comp_zombie]},{1},0,1,default_t::def_bool,ss_comp,&comp[comp_zombie]},
        {"comp_infcheat",{&default_comp[comp_infcheat]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_infcheat]},
        {"comp_stairs",{&default_comp[comp_stairs]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_stairs]},
        {"comp_telefrag",{&default_comp[comp_telefrag]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_telefrag]},
        {"comp_dropoff",{&default_comp[comp_dropoff]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_dropoff]},
        {"comp_falloff",{&default_comp[comp_falloff]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_falloff]},
        {"comp_staylift",{&default_comp[comp_staylift]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_staylift]},
        {"comp_doorstuck",{&default_comp[comp_doorstuck]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_doorstuck]},
        {"comp_pursuit",{&default_comp[comp_pursuit]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_pursuit]},
        {"comp_vile",{&default_comp[comp_vile]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_vile]},
        {"comp_pain",{&default_comp[comp_pain]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_pain]},
        {"comp_skull",{&default_comp[comp_skull]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_skull]},
        {"comp_blazing",{&default_comp[comp_blazing]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_blazing]},
        {"comp_doorlight",{&default_comp[comp_doorlight]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_doorlight]},
        {"comp_god",{&default_comp[comp_god]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_god]},
        {"comp_skymap",{&default_comp[comp_skymap]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_skymap]},
        {"comp_floors",{&default_comp[comp_floors]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_floors]},
        {"comp_model",{&default_comp[comp_model]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_model]},
        {"comp_zerotags",{&default_comp[comp_zerotags]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_zerotags]},
        {"comp_moveblock",{&default_comp[comp_moveblock]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_moveblock]},
        {"comp_sound",{&default_comp[comp_sound]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_sound]},
        {"comp_666",{&default_comp[comp_666]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_666]},
        {"comp_soul",{&default_comp[comp_soul]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_soul]},
        {"comp_maskedanim",{&default_comp[comp_maskedanim]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_maskedanim]},
    //e6y
        {"PrBoom-plus compatibility settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        {"comp_ouchface",{&default_comp[comp_ouchface]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_ouchface]},
        {"comp_maxhealth",{&default_comp[comp_maxhealth]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_maxhealth]},
        {"comp_translucency",{&default_comp[comp_translucency]},{0},0,1,default_t::def_bool,ss_comp,&comp[comp_translucency]},

        {"Sound settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        {"snd_pcspeaker",{&snd_pcspeaker},{0}, 0, 1, default_t::def_bool,ss_none},
        {"sound_card",{&snd_card},{-1},-1,7,       // jff 1/18/98 allow Allegro drivers
         default_t::def_int,ss_none}, // select sounds driver (DOS), -1 is autodetect, 0 is none; in Linux, non-zero enables sound
        {"music_card",{&mus_card},{-1},-1,9,       //  to be set,  -1 = autodetect
         default_t::def_int,ss_none}, // select music driver (DOS), -1 is autodetect, 0 is none"; in Linux, non-zero enables music
        {"pitched_sounds",{&pitched_sounds},{0},0,1, // killough 2/21/98
         default_t::def_bool,ss_none}, // enables variable pitch in sound effects (from id's original code)
        {"samplerate",{&snd_samplerate},{44100},11025,48000, default_t::def_int,ss_none},
        {"sfx_volume",{&snd_SfxVolume},{8},0,15, default_t::def_int,ss_none},
        {"music_volume",{&snd_MusicVolume},{8},0,15, default_t::def_int,ss_none},
        {"mus_pause_opt",{&mus_pause_opt},{1},0,2, // CPhipps - music pausing
         default_t::def_int, ss_none}, // 0 = kill music when paused, 1 = pause music, 2 = let music continue
        {"snd_channels",{&default_numChannels},{32},1,32,
         default_t::def_int,ss_none}, // number of audio events simultaneously // killough
#ifdef _WIN32
        {"snd_midiplayer",{NULL, &snd_midiplayer},{0,"fluidsynth"},UL,UL,default_t::def_str,ss_none},
  {"snd_soundfont",{NULL, &snd_soundfont},{0,"TimGM6mb.sf2"},UL,UL,default_t::def_str,ss_none}, // soundfont name for synths that support it
#else
        {"snd_midiplayer",{NULL, &snd_midiplayer},{0,"sdl"},UL,UL,default_t::def_str,ss_none},
        {"snd_soundfont",{NULL, &snd_soundfont},{0,"/usr/share/sounds/sf3/default-GM.sf3"},UL,UL,default_t::def_str,ss_none}, // soundfont name for synths that support it
#endif
        {"snd_mididev",{NULL, &snd_mididev},{0,""},UL,UL,default_t::def_str,ss_none}, // midi device to use for portmidiplayer

#ifdef _WIN32
        {"mus_extend_volume",{&mus_extend_volume},{0},0,1,
   default_t::def_bool,ss_none}, // e6y: apply midi volume to all midi devices
#endif
        {"mus_fluidsynth_chorus",{&mus_fluidsynth_chorus},{0},0,1,default_t::def_bool,ss_none},
        {"mus_fluidsynth_reverb",{&mus_fluidsynth_reverb},{0},0,1,default_t::def_bool,ss_none},
        {"mus_fluidsynth_gain",{&mus_fluidsynth_gain},{50},0,1000,default_t::def_int,ss_none}, // NSM  fine tune fluidsynth output level
        {"mus_opl_gain",{&mus_opl_gain},{50},0,1000,default_t::def_int,ss_none}, // NSM  fine tune opl output level

        {"Video settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        {"videomode",{NULL, &default_videomode},{0,"8bit"},UL,UL,default_t::def_str,ss_none},
        /* 640x480 default resolution */
        {"screen_resolution",{NULL, &screen_resolution},{0,"640x480"},UL,UL,default_t::def_str,ss_none},
        ...
        {"translucency",{&default_translucency},{1},0,1,   // phares
         default_t::def_bool,ss_none}, // enables translucency
        {"tran_filter_pct",{&tran_filter_pct},{66},0,100,         // killough 2/21/98
         default_t::def_int,ss_none}, // set percentage of foreground/background translucency mix
        {"screenblocks",{&screenblocks},{10},3,11,  // killough 2/21/98: default to 10
         default_t::def_int,ss_none},
        {"usegamma",{&usegamma},{0},0,4, //jff 3/6/98 fix erroneous upper limit in range
         default_t::def_int,ss_none}, // gamma correction level // killough 1/18/98
        ...
        {"filter_wall",{(int*)&drawvars.filterwall},{RDRAW_FILTER_POINT},
         RDRAW_FILTER_POINT, RDRAW_FILTER_ROUNDED, default_t::def_int,ss_none},
        ...
        {"filter_z",{(int*)&drawvars.filterz},{RDRAW_FILTER_POINT},
         RDRAW_FILTER_POINT, RDRAW_FILTER_LINEAR, default_t::def_int,ss_none},
        {"filter_patch",{(int*)&drawvars.filterpatch},{RDRAW_FILTER_POINT},
         RDRAW_FILTER_POINT, RDRAW_FILTER_ROUNDED, default_t::def_int,ss_none},
        {"filter_threshold",{(int*)&drawvars.mag_threshold},{49152},
         0, UL, default_t::def_int,ss_none},
        {"sprite_edges",{(int*)&drawvars.sprite_edges},{RDRAW_MASKEDCOLUMNEDGE_SQUARE},
         RDRAW_MASKEDCOLUMNEDGE_SQUARE, RDRAW_MASKEDCOLUMNEDGE_SLOPED, default_t::def_int,ss_none},
        ...
        {"gl_nearclip",{&gl_nearclip},{5},0,UL,
         default_t::def_int,ss_none}, /* near clipping plane pos */
        ...
        {"gl_texture_filter",{(int*)&gl_texture_filter},
         {filter_nearest_mipmap_linear}, filter_nearest, filter_count - 1, default_t::def_int,ss_none},
        {"gl_sprite_filter",{(int*)&gl_sprite_filter},
         {filter_nearest}, filter_nearest, filter_linear_mipmap_nearest, default_t::def_int,ss_none},
        {"gl_patch_filter",{(int*)&gl_patch_filter},
         {filter_nearest}, filter_nearest, filter_linear, default_t::def_int,ss_none},
        {"gl_texture_filter_anisotropic",{(int*)&gl_texture_filter_anisotropic},
         {gl_anisotropic_8x}, gl_anisotropic_off, gl_anisotropic_16x, default_t::def_int,ss_none},
        {"gl_tex_format_string", {NULL,&gl_tex_format_string}, {0,"GL_RGBA"},UL,UL,
         default_t::def_str,ss_none},
        {"gl_sprite_offset",{&gl_sprite_offset_default},{0}, 0, 5,
         default_t::def_int,ss_none}, // amount to bring items out of floor (GL) Mead 8/13/03
        {"gl_sprite_blend",{&gl_sprite_blend},{0},0,1,
         default_t::def_bool,ss_none},
        {"gl_mask_sprite_threshold",{&gl_mask_sprite_threshold},{50},0,100,
         default_t::def_int,ss_none},
        {"gl_skymode",{(int*)&gl_skymode},
         {skytype_auto}, skytype_auto, skytype_count - 1, default_t::def_int,ss_none},
        ...
        { "Input settings", { NULL }, { 0 }, UL, UL, default_t::def_none, ss_none },

        { "input_profile", { &dsda_input_profile }, { 0 }, 0, DSDA_INPUT_PROFILE_COUNT - 1, default_t::def_int, ss_none },

        { "input_forward", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_forward, { 'w', 2, -1 } },
        { "input_backward", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_backward, { 's', -1, -1 } },
        { "input_turnleft", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_turnleft, { 'e', -1, -1 } },
        { "input_turnright", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_turnright, { 'q', -1, -1 } },
        { "input_speed", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_speed, { KEYD_RSHIFT, -1, 2 } },
        { "input_strafeleft", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_strafeleft, { 'a', -1, 4 } },
        { "input_straferight", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_straferight, { 'd', -1, 5 } },
        { "input_strafe", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_strafe, { KEYD_RALT, 1, 1 } },
        { "input_autorun", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_autorun, { KEYD_CAPSLOCK, -1, -1 } },
        { "input_reverse", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_reverse, { '/', -1, -1 } },
        { "input_use", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_use, { ' ', -1, 3 } },
        { "input_flyup", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_flyup, { '.', -1, -1 } },
        { "input_flydown", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_flydown, { ',', -1, -1 } },
        { "input_flycenter", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_flycenter, { 0, -1, -1 } },
        { "input_mlook", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_mlook, { '\\', -1, -1 } },
        { "input_novert", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_novert, { 0, -1, -1 } },

        { "input_weapon1", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_weapon1, { '1', -1, -1 } },
        { "input_weapon2", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_weapon2, { '2', -1, -1 } },
        { "input_weapon3", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_weapon3, { '3', -1, -1 } },
        { "input_weapon4", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_weapon4, { '4', -1, -1 } },
        { "input_weapon5", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_weapon5, { '5', -1, -1 } },
        { "input_weapon6", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_weapon6, { '6', -1, -1 } },
        { "input_weapon7", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_weapon7, { '7', -1, -1 } },
        { "input_weapon8", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_weapon8, { '8', -1, -1 } },
        { "input_weapon9", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_weapon9, { '9', -1, -1 } },
        { "input_nextweapon", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_nextweapon, { KEYD_MWHEELUP, -1, -1 } },
        { "input_prevweapon", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_prevweapon, { KEYD_MWHEELDOWN, -1, -1 } },
        { "input_toggleweapon", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_toggleweapon, { '0', -1, -1 } },
        { "input_fire", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_fire, { KEYD_RCTRL, 0, 0 } },

        { "input_setup", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_setup, { 0, -1, -1 } },
        { "input_pause", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_pause, { KEYD_PAUSE, -1, -1 } },
        { "input_map", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map, { KEYD_TAB, -1, -1 } },
        { "input_soundvolume", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_soundvolume, { KEYD_F4, -1, -1 } },
        { "input_hud", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_hud, { KEYD_F5, -1, -1 } },
        { "input_messages", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_messages, { KEYD_F8, -1, -1 } },
        { "input_gamma", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_gamma, { KEYD_F11, -1, -1 } },
        { "input_spy", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_spy, { KEYD_F12, -1, -1 } },
        { "input_zoomin", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_zoomin, { '=', -1, -1 } },
        { "input_zoomout", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_zoomout, { '-', -1, -1 } },
        { "input_screenshot", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_screenshot, { '*', -1, -1 } },
        { "input_savegame", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_savegame, { KEYD_F2, -1, -1 } },
        { "input_loadgame", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_loadgame, { KEYD_F3, -1, -1 } },
        { "input_quicksave", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_quicksave, { KEYD_F6, -1, -1 } },
        { "input_quickload", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_quickload, { KEYD_F9, -1, -1 } },
        { "input_endgame", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_endgame, { KEYD_F7, -1, -1 } },
        { "input_quit", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_quit, { KEYD_F10, -1, -1 } },

        { "input_map_follow", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_follow, { 'f', -1, -1 } },
        { "input_map_zoomin", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_zoomin, { '=', -1, -1 } },
        { "input_map_zoomout", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_zoomout, { '-', -1, -1 } },
        { "input_map_up", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_up, { KEYD_UPARROW, -1, -1 } },
        { "input_map_down", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_down, { KEYD_DOWNARROW, -1, -1 } },
        { "input_map_left", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_left, { KEYD_LEFTARROW, -1, -1 } },
        { "input_map_right", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_right, { KEYD_RIGHTARROW, -1, -1 } },
        { "input_map_mark", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_mark, { 'm', -1, -1 } },
        { "input_map_clear", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_clear, { 'c', -1, -1 } },
        { "input_map_gobig", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_gobig, { '0', -1, -1 } },
        { "input_map_grid", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_grid, { 'g', -1, -1 } },
        { "input_map_rotate", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_rotate, { 'r', -1, -1 } },
        { "input_map_overlay", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_overlay, { 'o', -1, -1 } },
        { "input_map_textured", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_map_textured, { 0, -1, -1 } },

        { "input_chat", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_chat, { 't', -1, -1 } },
        { "input_chat_dest0", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_chat_dest0, { 'g', -1, -1 } },
        { "input_chat_dest1", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_chat_dest1, { 'i', -1, -1 } },
        { "input_chat_dest2", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_chat_dest2, { 'b', -1, -1 } },
        { "input_chat_dest3", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_chat_dest3, { 'r', -1, -1 } },
        { "input_chat_backspace", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_chat_backspace, { KEYD_BACKSPACE, -1, -1 } },
        { "input_chat_enter", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_chat_enter, { KEYD_ENTER, -1, -1 } },

        { "input_speed_up", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_speed_up, { 0, -1, -1 } },
        { "input_speed_down", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_speed_down, { 0, -1, -1 } },
        { "input_speed_default", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_speed_default, { 0, -1, -1 } },
        { "input_demo_skip", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_demo_skip, { KEYD_INSERT, -1, -1 } },
        { "input_demo_endlevel", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_demo_endlevel, { KEYD_END, -1, -1 } },
        { "input_walkcamera", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_walkcamera, { KEYD_KEYPAD0, -1, -1 } },
        { "input_join_demo", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_join_demo, { 0, -1, -1 } },
        { "input_restart", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_restart, { KEYD_HOME, -1, -1 } },
        { "input_nextlevel", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_nextlevel, { KEYD_PAGEDOWN, -1, -1 } },
        { "input_showalive", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_showalive, { KEYD_KEYPADDIVIDE, -1, -1 } },

        { "input_menu_down", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_menu_down, { KEYD_DOWNARROW, -1, -1 } },
        { "input_menu_up", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_menu_up, { KEYD_UPARROW, -1, -1 } },
        { "input_menu_left", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_menu_left, { KEYD_LEFTARROW, -1, -1 } },
        { "input_menu_right", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_menu_right, { KEYD_RIGHTARROW, -1, -1 } },
        { "input_menu_backspace", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_menu_backspace, { KEYD_BACKSPACE, -1, -1 } },
        { "input_menu_enter", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_menu_enter, { KEYD_ENTER, -1, -1 } },
        { "input_menu_escape", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_menu_escape, { KEYD_ESCAPE, -1, -1 } },
        { "input_menu_clear", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_menu_clear, { KEYD_DEL, -1, -1 } },

        { "input_iddqd", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_iddqd, { 0, -1, -1 } },
        { "input_idkfa", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idkfa, { 0, -1, -1 } },
        { "input_idfa", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idfa, { 0, -1, -1 } },
        { "input_idclip", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idclip, { 0, -1, -1 } },
        { "input_idbeholdh", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idbeholdh, { 0, -1, -1 } },
        { "input_idbeholdm", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idbeholdm, { 0, -1, -1 } },
        { "input_idbeholdv", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idbeholdv, { 0, -1, -1 } },
        { "input_idbeholds", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idbeholds, { 0, -1, -1 } },
        { "input_idbeholdi", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idbeholdi, { 0, -1, -1 } },
        { "input_idbeholdr", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idbeholdr, { 0, -1, -1 } },
        { "input_idbeholda", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idbeholda, { 0, -1, -1 } },
        { "input_idbeholdl", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idbeholdl, { 0, -1, -1 } },
        { "input_idmypos", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idmypos, { 0, -1, -1 } },
        { "input_idrate", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_idrate, { 0, -1, -1 } },
        { "input_iddt", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_iddt, { 0, -1, -1 } },

        { "input_lookup", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_lookup, { 0, -1, -1 } },
        { "input_lookdown", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_lookdown, { 0, -1, -1 } },
        { "input_lookcenter", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_lookcenter, { 0, -1, -1 } },
        { "input_use_artifact", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_use_artifact, { 0, -1, -1 } },
        { "input_arti_tome", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_arti_tome, { 0, -1, -1 } },
        { "input_arti_quartz", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_arti_quartz, { 0, -1, -1 } },
        { "input_arti_urn", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_arti_urn, { 0, -1, -1 } },
        { "input_arti_bomb", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_arti_bomb, { 0, -1, -1 } },
        { "input_arti_ring", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_arti_ring, { 0, -1, -1 } },
        { "input_arti_chaosdevice", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_arti_chaosdevice, { 0, -1, -1 } },
        { "input_arti_shadowsphere", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_arti_shadowsphere, { 0, -1, -1 } },
        { "input_arti_wings", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_arti_wings, { 0, -1, -1 } },
        { "input_arti_torch", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_arti_torch, { 0, -1, -1 } },
        { "input_arti_morph", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_arti_morph, { 0, -1, -1 } },
        { "input_invleft", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_invleft, { 0, -1, -1 } },
        { "input_invright", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_invright, { 0, -1, -1 } },
        { "input_store_quick_key_frame", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_store_quick_key_frame, { 0, -1, -1 } },
        { "input_restore_quick_key_frame", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_restore_quick_key_frame, { 0, -1, -1 } },
        { "input_rewind", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_rewind, { 0, -1, -1 } },
        { "input_cycle_profile", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_cycle_profile, { 0, -1, -1 } },
        { "input_cycle_palette", { NULL }, { 0 }, UL, UL, default_t::def_input, ss_keys, NULL, NULL,
          dsda_input_cycle_palette, { 0, -1, -1 } },

        {"Mouse settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        {"use_mouse",{&usemouse},{1},0,1,
         default_t::def_bool,ss_none}, // enables use of mouse with DOOM
        //jff 4/3/98 allow unlimited sensitivity
        {"mouse_sensitivity_horiz",{&mouseSensitivity_horiz},{10},0,UL,
         default_t::def_int,ss_none}, /* adjust horizontal (x) mouse sensitivity killough/mead */
        //jff 4/3/98 allow unlimited sensitivity
        {"mouse_sensitivity_vert",{&mouseSensitivity_vert},{1},0,UL,
         default_t::def_int,ss_none}, /* adjust vertical (y) mouse sensitivity killough/mead */

        {"Joystick settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        {"use_joystick",{&usejoystick},{0},0,2,
         default_t::def_int,ss_none}, // number of joystick to use (0 for none)

        {"Chat macros",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        {"chatmacro0", {0,&chat_macros[0]}, {0,HUSTR_CHATMACRO0},UL,UL,
         default_t::def_str,ss_chat}, // chat string associated with 0 key
        {"chatmacro1", {0,&chat_macros[1]}, {0,HUSTR_CHATMACRO1},UL,UL,
         default_t::def_str,ss_chat}, // chat string associated with 1 key
        {"chatmacro2", {0,&chat_macros[2]}, {0,HUSTR_CHATMACRO2},UL,UL,
         default_t::def_str,ss_chat}, // chat string associated with 2 key
        {"chatmacro3", {0,&chat_macros[3]}, {0,HUSTR_CHATMACRO3},UL,UL,
         default_t::def_str,ss_chat}, // chat string associated with 3 key
        {"chatmacro4", {0,&chat_macros[4]}, {0,HUSTR_CHATMACRO4},UL,UL,
         default_t::def_str,ss_chat}, // chat string associated with 4 key
        {"chatmacro5", {0,&chat_macros[5]}, {0,HUSTR_CHATMACRO5},UL,UL,
         default_t::def_str,ss_chat}, // chat string associated with 5 key
        {"chatmacro6", {0,&chat_macros[6]}, {0,HUSTR_CHATMACRO6},UL,UL,
         default_t::def_str,ss_chat}, // chat string associated with 6 key
        {"chatmacro7", {0,&chat_macros[7]}, {0,HUSTR_CHATMACRO7},UL,UL,
         default_t::def_str,ss_chat}, // chat string associated with 7 key
        {"chatmacro8", {0,&chat_macros[8]}, {0,HUSTR_CHATMACRO8},UL,UL,
         default_t::def_str,ss_chat}, // chat string associated with 8 key
        {"chatmacro9", {0,&chat_macros[9]}, {0,HUSTR_CHATMACRO9},UL,UL,
         default_t::def_str,ss_chat}, // chat string associated with 9 key
        ...
        {"mapcolor_back", {&mapcolor_back}, {247},0,255,  // black //jff 4/6/98 new black
         default_t::def_colour,ss_auto}, // color used as background for automap
        {"mapcolor_grid", {&mapcolor_grid}, {104},0,255,  // dk gray
         default_t::def_colour,ss_auto}, // color used for automap grid lines
        {"mapcolor_wall", {&mapcolor_wall}, {23},0,255,   // red-brown
         default_t::def_colour,ss_auto}, // color used for one side walls on automap
        {"mapcolor_fchg", {&mapcolor_fchg}, {55},0,255,   // lt brown
         default_t::def_colour,ss_auto}, // color used for lines floor height changes across
        {"mapcolor_cchg", {&mapcolor_cchg}, {215},0,255,  // orange
         default_t::def_colour,ss_auto}, // color used for lines ceiling height changes across
        {"mapcolor_clsd", {&mapcolor_clsd}, {208},0,255,  // white
         default_t::def_colour,ss_auto}, // color used for lines denoting closed doors, objects
        {"mapcolor_rkey", {&mapcolor_rkey}, {175},0,255,  // red
         default_t::def_colour,ss_auto}, // color used for red key sprites
        {"mapcolor_bkey", {&mapcolor_bkey}, {204},0,255,  // blue
         default_t::def_colour,ss_auto}, // color used for blue key sprites
        {"mapcolor_ykey", {&mapcolor_ykey}, {231},0,255,  // yellow
         default_t::def_colour,ss_auto}, // color used for yellow key sprites
        {"mapcolor_rdor", {&mapcolor_rdor}, {175},0,255,  // red
         default_t::def_colour,ss_auto}, // color used for closed red doors
        {"mapcolor_bdor", {&mapcolor_bdor}, {204},0,255,  // blue
         default_t::def_colour,ss_auto}, // color used for closed blue doors
        {"mapcolor_ydor", {&mapcolor_ydor}, {231},0,255,  // yellow
         default_t::def_colour,ss_auto}, // color used for closed yellow doors
        {"mapcolor_tele", {&mapcolor_tele}, {119},0,255,  // dk green
         default_t::def_colour,ss_auto}, // color used for teleporter lines
        {"mapcolor_secr", {&mapcolor_secr}, {252},0,255,  // purple
         default_t::def_colour,ss_auto}, // color used for lines around secret sectors
        {"mapcolor_exit", {&mapcolor_exit}, {0},0,255,    // none
         default_t::def_colour,ss_auto}, // color used for exit lines
        {"mapcolor_unsn", {&mapcolor_unsn}, {104},0,255,  // dk gray
         default_t::def_colour,ss_auto}, // color used for lines not seen without computer map
        {"mapcolor_flat", {&mapcolor_flat}, {88},0,255,   // lt gray
         default_t::def_colour,ss_auto}, // color used for lines with no height changes
        {"mapcolor_sprt", {&mapcolor_sprt}, {112},0,255,  // green
         default_t::def_colour,ss_auto}, // color used as things
        {"mapcolor_item", {&mapcolor_item}, {231},0,255,  // yellow
         default_t::def_colour,ss_auto}, // color used for counted items
        {"mapcolor_hair", {&mapcolor_hair}, {208},0,255,  // white
         default_t::def_colour,ss_auto}, // color used for dot crosshair denoting center of map
        {"mapcolor_sngl", {&mapcolor_sngl}, {208},0,255,  // white
         default_t::def_colour,ss_auto}, // color used for the single player arrow
        {"mapcolor_me",   {&mapcolor_me}, {112},0,255, // green
         default_t::def_colour,ss_auto}, // your (player) colour
        {"mapcolor_enemy",   {&mapcolor_enemy}, {177},0,255,
         default_t::def_colour,ss_auto},
        ...
        {"map_secret_after", {&map_secret_after}, {0},0,1, // show secret after gotten
         default_t::def_bool,ss_auto}, // prevents showing secret sectors till after entered
        {"map_point_coord", {&map_point_coordinates}, {0},0,1,
         default_t::def_bool,ss_auto},
        ...
        {"Heads-up display settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        //jff 2/16/98 defaults for color ranges in hud and status
        {"hudcolor_titl", {&hudcolor_titl}, {5},0,9,  // gold range
         default_t::def_int,ss_auto}, // color range used for automap level title
        {"hudcolor_xyco", {&hudcolor_xyco}, {3},0,9,  // green range
         default_t::def_int,ss_auto}, // color range used for automap coordinates
        {"hudcolor_mapstat_title", {&hudcolor_mapstat_title}, {6},0,9, // red range
         default_t::def_int,ss_auto}, // color range used for automap statistics for titles
        {"hudcolor_mapstat_value", {&hudcolor_mapstat_value}, {2},0,9,    // gray range
         default_t::def_int,ss_auto}, // color range used for automap statistics for data
        {"hudcolor_mapstat_time", {&hudcolor_mapstat_time}, {2},0,9,    // gray range
         default_t::def_int,ss_auto}, // color range used for automap statistics for level time and total time
        {"hudcolor_mesg", {&hudcolor_mesg}, {6},0,9,  // red range
         default_t::def_int,ss_mess}, // color range used for messages during play
        {"hudcolor_chat", {&hudcolor_chat}, {5},0,9,  // gold range
         default_t::def_int,ss_mess}, // color range used for chat messages and entry
        {"hudcolor_list", {&hudcolor_list}, {5},0,9,  // gold range  //jff 2/26/98
         default_t::def_int,ss_mess}, // color range used for message review
        {"hud_msg_lines", {&hud_msg_lines}, {1},1,16,  // 1 line scrolling window
         default_t::def_int,ss_mess}, // number of messages in review display (1=disable)
        {"hud_list_bgon", {&hud_list_bgon}, {0},0,1,  // solid window bg ena //jff 2/26/98
         default_t::def_bool,ss_mess}, // enables background window behind message review

        {"health_red",    {&health_red}   , {25},0,200, // below is red
         default_t::def_int,ss_stat}, // amount of health for red to yellow transition
        {"health_yellow", {&health_yellow}, {50},0,200, // below is yellow
         default_t::def_int,ss_stat}, // amount of health for yellow to green transition
        {"health_green",  {&health_green} , {100},0,200,// below is green, above blue
         default_t::def_int,ss_stat}, // amount of health for green to blue transition
        {"armor_red",     {&armor_red}    , {25},0,200, // below is red
         default_t::def_int,ss_stat}, // amount of armor for red to yellow transition
        {"armor_yellow",  {&armor_yellow} , {50},0,200, // below is yellow
         default_t::def_int,ss_stat}, // amount of armor for yellow to green transition
        {"armor_green",   {&armor_green}  , {100},0,200,// below is green, above blue
         default_t::def_int,ss_stat}, // amount of armor for green to blue transition
        {"ammo_red",      {&ammo_red}     , {25},0,100, // below 25% is red
         default_t::def_int,ss_stat}, // percent of ammo for red to yellow transition
        {"ammo_yellow",   {&ammo_yellow}  , {50},0,100, // below 50% is yellow, above green
         default_t::def_int,ss_stat}, // percent of ammo for yellow to green transition
        {"ammo_colour_behaviour",{(int*)&ammo_colour_behaviour},
         {ammo_colour_behaviour_max-1}, // whether backpack changes thresholds above
         0,ammo_colour_behaviour_max-1,default_t::def_int,ss_stat},
        ...
        {"hud_displayed", {&hud_displayed},  {0},0,1, // whether hud is displayed
         default_t::def_bool,ss_none}, // enables display of HUD

        {"Prboom-plus heads-up display settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        ...
        //e6y
        {"Prboom-plus mouse settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        ...
        {"Prboom-plus demos settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        ...
        {"Prboom-plus game settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        ...
        {"Prboom-plus misc settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        ...
        { "DSDA-Doom settings", { NULL }, { 0 }, UL, UL, default_t::def_none, ss_none },
        { "dsda_strict_mode", { &dsda_strict_mode }, { 1 }, 0, 1, default_t::def_bool, ss_stat },
        { "dsda_cycle_ghost_colors", { &dsda_cycle_ghost_colors }, { 0 }, 0, 1, default_t::def_bool, ss_stat },
        { "dsda_auto_key_frame_interval", { &dsda_auto_key_frame_interval }, { 1 }, 1, 600, default_t::def_int, ss_stat },
        { "dsda_auto_key_frame_depth", { &dsda_auto_key_frame_depth }, { 60 }, 0, 600, default_t::def_int, ss_stat },
        { "dsda_exhud", { &dsda_exhud }, { 0 }, 0, 1, default_t::def_bool, ss_stat },
        { "dsda_wipe_at_full_speed", { &dsda_wipe_at_full_speed }, { 1 }, 0, 1, default_t::def_bool, ss_stat },
        { "dsda_track_attempts", { &dsda_track_attempts }, { 1 }, 0, 1, default_t::def_bool, ss_stat },
        { "dsda_fine_sensitivity", { &dsda_fine_sensitivity }, { 0 }, 0, 99, default_t::def_int, ss_stat },

        // NSM
        {"Video capture encoding settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        {"cap_soundcommand",{NULL, &cap_soundcommand},{0,"ffmpeg -f s16le -ar %s -ac 2 -i - -c:a libopus -y temp_a.nut"},UL,UL,default_t::def_str,ss_none},
        {"cap_videocommand",{NULL, &cap_videocommand},{0,"ffmpeg -f rawvideo -pix_fmt rgb24 -r %r -s %wx%h -i - -c:v libx264 -y temp_v.nut"},UL,UL,default_t::def_str,ss_none},
        {"cap_muxcommand",{NULL, &cap_muxcommand},{0,"ffmpeg -i temp_v.nut -i temp_a.nut -c copy -y %f"},UL,UL,default_t::def_str,ss_none},
        {"cap_tempfile1",{NULL, &cap_tempfile1},{0,"temp_a.nut"},UL,UL,default_t::def_str,ss_none},
        {"cap_tempfile2",{NULL, &cap_tempfile2},{0,"temp_v.nut"},UL,UL,default_t::def_str,ss_none},
        {"cap_remove_tempfiles", {&cap_remove_tempfiles},{1},0,1,default_t::def_bool,ss_none},
        {"cap_fps", {&cap_fps},{60},16,300,default_t::def_int,ss_none},

        {"Prboom-plus video settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        ...
        {"fake_contrast", {&fake_contrast},  {1},0,1,
         default_t::def_bool,ss_stat}, /* cph - allow crappy fake contrast to be disabled */
        ...
        {"Prboom-plus OpenGL settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        ...
        {"render_fov", {&render_fov},  {90},20,160,
         default_t::def_int,ss_stat},
        {"gl_spriteclip",{(int*)&gl_spriteclip},{spriteclip_smart}, spriteclip_const, spriteclip_smart, default_t::def_int,ss_none},
        ...
        {"gl_texture_hqresize_textures", {&gl_texture_hqresize_textures},
         {hq_scale_2x},hq_scale_none,hq_scale_max-1, default_t::def_int,ss_stat},
        {"gl_texture_hqresize_sprites", {&gl_texture_hqresize_sprites},
         {hq_scale_none},hq_scale_none,hq_scale_max-1, default_t::def_int,ss_stat},
        ...
        {"gl_lightmode",{(int*)&gl_lightmode_default},{gl_lightmode_glboom},
         gl_lightmode_glboom, gl_lightmode_last-1, default_t::def_int,ss_none},
        {"gl_light_ambient", {&gl_light_ambient},  {20},1,255,
         default_t::def_int,ss_stat},
        {"gl_fog", {&gl_fog},  {1},0,1,
         default_t::def_bool,ss_stat},
        {"gl_fog_color", {&gl_fog_color},  {0},0,0xffffff,
         default_t::def_hex,ss_stat},
        ...
        {"Prboom-plus emulation settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        ...
        {"Prboom-plus 'bad' compatibility settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
...
#ifdef USE_WINDOWS_LAUNCHER
        {"Prboom-plus launcher settings",{NULL},{0},UL,UL,default_t::def_none,ss_none},
  {"launcher_enable",{(int*)&launcher_enable},{launcher_enable_never},
   launcher_enable_never, launcher_enable_count - 1, default_t::def_int,ss_none},
  {"launcher_history0", {NULL,&launcher_history[0]}, {0,""},UL,UL,default_t::def_str,ss_none},
  {"launcher_history1", {NULL,&launcher_history[1]}, {0,""},UL,UL,default_t::def_str,ss_none},
  {"launcher_history2", {NULL,&launcher_history[2]}, {0,""},UL,UL,default_t::def_str,ss_none},
  {"launcher_history3", {NULL,&launcher_history[3]}, {0,""},UL,UL,default_t::def_str,ss_none},
  {"launcher_history4", {NULL,&launcher_history[4]}, {0,""},UL,UL,default_t::def_str,ss_none},
  {"launcher_history5", {NULL,&launcher_history[5]}, {0,""},UL,UL,default_t::def_str,ss_none},
  {"launcher_history6", {NULL,&launcher_history[6]}, {0,""},UL,UL,default_t::def_str,ss_none},
  {"launcher_history7", {NULL,&launcher_history[7]}, {0,""},UL,UL,default_t::def_str,ss_none},
  {"launcher_history8", {NULL,&launcher_history[8]}, {0,""},UL,UL,default_t::def_str,ss_none},
  {"launcher_history9", {NULL,&launcher_history[9]}, {0,""},UL,UL,default_t::def_str,ss_none},
#endif
        {"Prboom-plus demo patterns list. Put your patterns here",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        {"demo_patterns_mask", {NULL, &demo_patterns_mask, &demo_patterns_count, &demo_patterns_list}, {0,"demo_pattern",9, &demo_patterns_list_def[0]},UL,UL,default_t::def_arr,ss_none},
        {"demo_pattern0", {NULL,&demo_patterns_list_def[0]},
         {0,"DOOM 2: Hell on Earth/((lv)|(nm)|(pa)|(ty))\\d\\d.\\d\\d\\d\\.lmp/doom2.wad"},UL,UL,default_t::def_str,ss_none},
        {"demo_pattern1", {NULL,&demo_patterns_list_def[1]},
         {0,"DOOM 2: Plutonia Experiment/p(c|f|l|n|p|r|s|t)\\d\\d.\\d\\d\\d\\.lmp/doom2.wad|plutonia.wad"},UL,UL,default_t::def_str,ss_none},
        {"demo_pattern2", {NULL,&demo_patterns_list_def[2]},
         {0,"DOOM 2: TNT - Evilution/((e(c|f|v|p|r|s|t))|(tn))\\d\\d.\\d\\d\\d\\.lmp/doom2.wad|tnt.wad"},UL,UL,default_t::def_str,ss_none},
        {"demo_pattern3", {NULL,&demo_patterns_list_def[3]},
         {0,"The Ultimate DOOM/(((e|f|n|p|r|t|u)\\dm\\d)|(n\\ds\\d)).\\d\\d\\d\\.lmp/doom.wad"},UL,UL,default_t::def_str,ss_none},
        {"demo_pattern4", {NULL,&demo_patterns_list_def[4]},
         {0,"Alien Vendetta/a(c|f|n|p|r|s|t|v)\\d\\d.\\d\\d\\d\\.lmp/doom2.wad|av.wad|av.deh"},UL,UL,default_t::def_str,ss_none},
        {"demo_pattern5", {NULL,&demo_patterns_list_def[5]},
         {0,"Requiem/r(c|f|n|p|q|r|s|t)\\d\\d.\\d\\d\\d\\.lmp/doom2.wad|requiem.wad|req21fix.wad|reqmus.wad"},UL,UL,default_t::def_str,ss_none},
        {"demo_pattern6", {NULL,&demo_patterns_list_def[6]},
         {0,"Hell Revealed/h(c|e|f|n|p|r|s|t)\\d\\d.\\d\\d\\d\\.lmp/doom2.wad|hr.wad|hrmus.wad"},UL,UL,default_t::def_str,ss_none},
        {"demo_pattern7", {NULL,&demo_patterns_list_def[7]},
         {0,"Memento Mori/mm\\d\\d.\\d\\d\\d\\.lmp/doom2.wad|mm.wad|mmmus.wad"},UL,UL,default_t::def_str,ss_none},
        {"demo_pattern8", {NULL,&demo_patterns_list_def[8]},
         {0,"Memento Mori 2/m2\\d\\d.\\d\\d\\d\\.lmp/doom2.wad|mm2.wad|mm2mus.wad"},UL,UL,default_t::def_str,ss_none},

        {"Weapon preferences",{NULL},{0},UL,UL,default_t::def_none,ss_none},
        // killough 2/8/98: weapon preferences set by user:
        {"weapon_choice_1", {&weapon_preferences[0][0]}, {6}, 0,9,
         default_t::def_int,ss_weap}, // first choice for weapon (best)
        {"weapon_choice_2", {&weapon_preferences[0][1]}, {9}, 0,9,
         default_t::def_int,ss_weap}, // second choice for weapon
        {"weapon_choice_3", {&weapon_preferences[0][2]}, {4}, 0,9,
         default_t::def_int,ss_weap}, // third choice for weapon
        {"weapon_choice_4", {&weapon_preferences[0][3]}, {3}, 0,9,
         default_t::def_int,ss_weap}, // fourth choice for weapon
        {"weapon_choice_5", {&weapon_preferences[0][4]}, {2}, 0,9,
         default_t::def_int,ss_weap}, // fifth choice for weapon
        {"weapon_choice_6", {&weapon_preferences[0][5]}, {8}, 0,9,
         default_t::def_int,ss_weap}, // sixth choice for weapon
        {"weapon_choice_7", {&weapon_preferences[0][6]}, {5}, 0,9,
         default_t::def_int,ss_weap}, // seventh choice for weapon
        {"weapon_choice_8", {&weapon_preferences[0][7]}, {7}, 0,9,
         default_t::def_int,ss_weap}, // eighth choice for weapon
        {"weapon_choice_9", {&weapon_preferences[0][8]}, {1}, 0,9,
         default_t::def_int,ss_weap}, // ninth choice for weapon (worst)
...
struct default_s *M_LookupDefault(const char *name)
{
  ...
  for (i = 0 ; i < numdefaults ; i++)
  {
    if ((defaults[i].type != default_t::def_none) && !strcmp(name, defaults[i].name))
      return &defaults[i];
  }
...
void M_LoadDefaults (void)
{
  ...
  for (i = 0 ; i < numdefaults ; i++) {
    if (defaults[i].type == default_t::def_input)
    {
      int c;
...
//                free((*arr)[(*index)]);
        ...
        for (i = 0 ; i < numdefaults ; i++)
          if ((defaults[i].type != default_t::def_none) && !strcmp(def, defaults[i].name))
            {
              // e6y: arrays
              if (defaults[i].type == default_t::def_arr)
              {
