...
default_t defaults[] = {
    ...
    {"demo_insurance",
     ...
     2, // killough 3/31/98
     default_t::def_int,
     ss_none}, // 1=take special steps ensuring demo sync, 2=only during
               // recordings
    {"endoom_mode",
     {&endoom_mode},
     {5},
    ...
    {"comp_maxhealth",
     ...
     &comp[comp_maxhealth]},
    {"comp_translucency",
     {&default_comp[comp_translucency]},
     {0},
     0,
     1,
     default_t::def_bool,
    ...
    {"use_fullscreen",
     ...
     default_t::def_bool,
     ss_none},
    {"render_vsync", {&render_vsync}, {1}, 0, 1, default_t::def_bool, ss_none},
    {"translucency",
    ...
    {"gl_finish", {&gl_finish}, {1}, 0, 1, default_t::def_bool, ss_none},
    {"gl_clear", {&gl_clear}, {0}, 0, 1, default_t::def_bool, ss_none},
    {"gl_ztrick", {&gl_ztrick}, {0}, 0, 1, default_t::def_bool, ss_none},
    {"gl_nearclip",
     {&gl_nearclip},
     {5},
     0,
    ...
    {"map_use_multisamling",
     ...
     default_t::def_bool,
     ss_auto},
    {"map_textured", {&map_textured}, {1}, 0, 1, default_t::def_bool, ss_auto},
    {"map_textured_trans",
     {&map_textured_trans},
     {100},
     0,
    ...
    {"hud_num", {&hud_num}, {6}, 0, 100, default_t::def_int, ss_none},
    // jff 2/23/98
    {"hud_displayed",
     {&hud_displayed},
     {0},
    ...
    {"interpolation_maxobjects",
     ...
     default_t::def_int,
     ss_stat},
    {"speed_step", {&speed_step}, {0}, 0, 1000, default_t::def_int, ss_none},
    ...
    {"screenshot_dir",
     ...
     default_t::def_str,
     ss_none},
    {"health_bar", {&health_bar}, {0}, 0, 1, default_t::def_bool, ss_stat},
    ...
    {"integer_scaling",
     ...
     default_t::def_bool,
     ss_stat},
    {"render_aspect", {&render_aspect}, {0}, 0, 4, default_t::def_int, ss_stat},
    ...
    {"render_multisampling",
     ...
     default_t::def_int,
     ss_stat},
    {"render_fov", {&render_fov}, {90}, 20, 160, default_t::def_int, ss_stat},
    {"gl_spriteclip",
     {(int *)&gl_spriteclip},
     {spriteclip_smart},
     spriteclip_const,
    ...
    {"gl_light_ambient",
     ...
     default_t::def_int,
     ss_stat},
    {"gl_fog", {&gl_fog}, {1}, 0, 1, default_t::def_bool, ss_stat},
    {"gl_fog_color",
     {&gl_fog_color},
     {0},
     0,
    ...
    // HERETIC_TODO: this causes seg faults - because of dynamic S_music_files I
    // guess cournia - support for arbitrary music file (defaults are mp3)
