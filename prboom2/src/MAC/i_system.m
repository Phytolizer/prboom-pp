...
{
    char *cStr =
        malloc([str lengthOfBytesUsingEncoding:NSUTF8StringEncoding] + 1);
...
const char *I_DoomExeDir(void)
{
    ...
    [[NSFileManager defaultManager] createDirectoryAtPath:exeDir
                                               attributes:nil];
...
char *I_FindFileInternal(const char *wf_name, const char *ext, bool isStatic)
{
    ...
    {
        NSString *path =
            [NSString stringWithFormat:@"%@/%@", [paths objectAtIndex:i],
