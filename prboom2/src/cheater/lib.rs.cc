...
namespace cheater {
extern "C" {
void rust$cheater$cxxbridge1$start_game(::rust::Vec<::Cheats> *return$) noexcept;
} // extern "C"
} // namespace cheater
} // namespace rust
...
extern "C" {
void cxxbridge1$rust_vec$Cheats$new(const ::rust::Vec<::Cheats> *ptr) noexcept;
void cxxbridge1$rust_vec$Cheats$drop(::rust::Vec<::Cheats> *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$Cheats$len(const ::rust::Vec<::Cheats> *ptr) noexcept;
::std::size_t cxxbridge1$rust_vec$Cheats$capacity(const ::rust::Vec<::Cheats> *ptr) noexcept;
const ::Cheats *cxxbridge1$rust_vec$Cheats$data(const ::rust::Vec<::Cheats> *ptr) noexcept;
void cxxbridge1$rust_vec$Cheats$reserve_total(::rust::Vec<::Cheats> *ptr, ::std::size_t cap) noexcept;
void cxxbridge1$rust_vec$Cheats$set_len(::rust::Vec<::Cheats> *ptr, ::std::size_t len) noexcept;
} // extern "C"

namespace rust {
inline namespace cxxbridge1 {
template <>
Vec<::Cheats>::Vec() noexcept {
  cxxbridge1$rust_vec$Cheats$new(this);
}
template <>
void Vec<::Cheats>::drop() noexcept {
  return cxxbridge1$rust_vec$Cheats$drop(this);
}
template <>
::std::size_t Vec<::Cheats>::size() const noexcept {
  return cxxbridge1$rust_vec$Cheats$len(this);
}
template <>
::std::size_t Vec<::Cheats>::capacity() const noexcept {
  return cxxbridge1$rust_vec$Cheats$capacity(this);
}
template <>
const ::Cheats *Vec<::Cheats>::data() const noexcept {
  return cxxbridge1$rust_vec$Cheats$data(this);
}
template <>
void Vec<::Cheats>::reserve_total(::std::size_t cap) noexcept {
  return cxxbridge1$rust_vec$Cheats$reserve_total(this, cap);
}
template <>
void Vec<::Cheats>::set_len(::std::size_t len) noexcept {
