...
typedef enum
{
    ...
    S_SKEL_DIE5,
    S_SKEL_DIE6,
    S_REVENANT_RESURRECT1,
    S_SKEL_RAISE2,
    S_SKEL_RAISE3,
    S_SKEL_RAISE4,
    S_SKEL_RAISE5,
    S_SKEL_RAISE6,
    S_MANCUBUS_PROJECTILE1,
    S_FATSHOT2,
    S_MANCUBUS_PROJECTILE_EXPLODE1,
    S_FATSHOTX2,
    S_FATSHOTX3,
    S_MANCUBUS_IDLE,
    S_FATT_STND2,
    ...
    S_CPOS_RUN7,
    S_CPOS_RUN8,
    S_CHAINGUNNER_ATTACK1,
    S_CPOS_ATK2,
    S_CPOS_ATK3,
    S_CPOS_ATK4,
    S_CHAINGUNNER_PAIN,
    S_CPOS_PAIN2,
    S_CHAINGUNNER_DEATH1,
    S_CPOS_DIE2,
    S_CPOS_DIE3,
    S_CPOS_DIE4,
    S_CPOS_DIE5,
    ...
    S_SKULL_DIE5,
    S_SKULL_DIE6,
    S_SPIDERMASTERMIND_IDLE,
    S_SPID_STND2,
    S_SPIDERMASTERMIND_RUN1,
    S_SPID_RUN2,
    S_SPID_RUN3,
    S_SPID_RUN4,
    S_SPID_RUN5,
    ...
    S_SPID_RUN11,
    S_SPID_RUN12,
    S_SPIDERMASTERMIND_ATTACK1,
    S_SPID_ATK2,
    S_SPID_ATK3,
    S_SPID_ATK4,
    S_SPIDERMASTERMIND_PAIN,
    S_SPID_PAIN2,
    S_SPIDERMASTERMIND_DEATH1,
    S_SPID_DIE2,
    S_SPID_DIE3,
    S_SPID_DIE4,
    S_SPID_DIE5,
    ...
    S_BSPI_RUN11,
    S_BSPI_RUN12,
    S_ARACHNOTRON_ATTACK1,
    S_BSPI_ATK2,
    S_BSPI_ATK3,
    S_BSPI_ATK4,
    S_ARACHNOTRON_PAIN,
    S_BSPI_PAIN2,
    S_ARACHNOTRON_DEATH1,
    S_BSPI_DIE2,
    S_BSPI_DIE3,
    S_BSPI_DIE4,
    S_BSPI_DIE5,
    ...
    S_CYBER_DIE9,
    S_CYBER_DIE10,
    S_PAINELEMENTAL_IDLE,
    S_PAINELEMENTAL_RUN1,
    S_PAIN_RUN2,
    S_PAIN_RUN3,
    S_PAIN_RUN4,
    S_PAIN_RUN5,
    S_PAIN_RUN6,
    S_PAINELEMENTAL_ATTACK1,
    S_PAIN_ATK2,
    S_PAIN_ATK3,
    S_PAIN_ATK4,
    S_PAINELEMENTAL_PAIN,
    S_PAIN_PAIN2,
    S_PAINELEMENTAL_DEATH1,
    S_PAIN_DIE2,
    S_PAIN_DIE3,
    S_PAIN_DIE4,
    S_PAIN_DIE5,
    S_PAIN_DIE6,
    S_PAINELEMENTAL_RESURRECT1,
    S_PAIN_RAISE2,
    S_PAIN_RAISE3,
    S_PAIN_RAISE4,
    S_PAIN_RAISE5,
    ...
    S_SSWV_RAISE4,
    S_SSWV_RAISE5,
    S_COMMANDERKEEN_IDLE,
    S_COMMANDERKEEN_DEATH1,
    S_COMMKEEN2,
    S_COMMKEEN3,
    S_COMMKEEN4,
    S_COMMKEEN5,
    ...
    HERETIC_S_PLAY_FDTH20, // < 1.0 executable (fire death animation was
                           // extended)
