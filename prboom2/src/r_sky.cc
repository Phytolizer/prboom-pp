...
void R_InitSkyMap()
{
    if (!GetMouseLook())
    {
        ...
        {
            skyiscale = (fixed_t
            )(((uint_64_t)FRACUNIT * SCREENWIDTH * 200) /
    ...
    else
    {
        ...
        // There are various combinations for sky rendering depending on how
        // tall the sky is:
        //        h <  128: Unstretched and tiled, centered on horizon
        // 128 <= h <  200: Can possibly be stretched. When unstretched, the
        // baseline is
        //                  28 rows below the horizon so that the top of the
        //                  texture aligns with the top of the screen when
        //                  looking straight ahead. When stretched, it is scaled
        ...
        //        h >  200: Unstretched, but the baseline is shifted down so
        //        that the top
        //                  of the texture is at the top of the screen when
        //                  looking fully up.
